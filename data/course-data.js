window.KHAE_GRADE1_DATA = {
  "course": {
    "title": "Khaemenes Academy First Grade — 36 Unit A+ Curriculum",
    "subtitle": "Universal First Grade Readiness · In-House Curriculum · Advanced Whole-Child Foundation",
    "code": "KHAE-GRADE1-36-APLUS",
    "grade": "First Grade",
    "units": 36,
    "lessonsPerUnit": 5,
    "dailyLessons": 180,
    ...
    "localReviewNote": "Designed to exceed a single-state checklist by spanning broad first-grade domains. Families, schools, or evaluators should still review local compliance requirements."
  },
  "standardsFamilies": [
    {
      "code": "KHAE-DAP-1",
      "label": "Developmentally Appropriate First Grade Practice",
      "description": "Joyful, strengths-based, active learning with explicit instruction, practice, play, talk, movement, and reflection."
    },
    {
      "code": "KHAE-ELA-1",
      "label": "Grade 1 English Language Arts",
      "description": "Foundational skills, phonics, fluency, literature, informational text, writing, language, speaking, and listening."
    },
    {
      "code": "KHAE-MATH-1",
      "label": "Grade 1 Mathematics",
      "description": "Addition/subtraction, place value, measurement, data, geometry, time, fractions as equal shares, reasoning, and problem solving."
    },
    {
      "code": "KHAE-SCI-1",
      "label": "Grade 1 Science and Engineering",
      "description": "Light, sound, plants, animals, weather, Earth materials, patterns, design, observation, evidence, and safe investigations."
    },
    {
      "code": "KHAE-SS-1",
      "label": "Grade 1 Social Studies and Civics",
      "description": "Families, communities, maps, culture, time, civic symbols, service, economics, goods/services, responsibilities, and history."
    },
    {
      "code": "KHAE-SEL-1",
      "label": "Social-Emotional Learning",
      "description": "Self-awareness, self-management, social awareness, relationship skills, responsible decision-making, confidence, repair, and persistence."
    },
    {
      "code": "KHAE-ART-1",
    ...
    {
      "code": "KHAE-PEH-1",
      "label": "Health, Movement, and Physical Development",
      "description": "Fine/gross motor, balance, coordination, safe movement, nutrition, hygiene, rest, health choices, and body confidence."
    },
    {
      "code": "KHAE-TECH-1",
      "label": "Tools, Technology, and Unplugged Computing",
      "description": "Safe tool use, digital citizenship, sequence, algorithms, debugging, creative communication, and computational thinking."
    },
    {
      "code": "KHAE-PORT-1",
      "label": "Portfolio, Assessment, and Communication",
      "description": "Weekly evidence, performance checks, midterm, final, self-reflection, family communication, and teacher documentation."
    }
  ],
  "units": [
    {
      ...
      "weeklyAssessment": {
        ...
        "items": [
          ...
          },
          {
            "domain": "Writing",
            "points": 1,
            "prompt": "Writes, dictates, labels, revises, or illustrates a complete idea connected to the unit."
          },
          {
          ...
          },
          {
            ...
            "points": 1,
            "prompt": "Shows reasoning using objects, drawings, numbers, words, or equations."
          },
          {
          ...
          },
          {
            "domain": "Independence",
            "points": 1,
            "prompt": "Follows routines, uses tools safely, and completes work with appropriate effort."
          },
          {
            "domain": "Portfolio Evidence",
            "points": 1,
            "prompt": "Files a weekly sample or teacher note that shows learning progress."
          }
        ]
      }
    },
        ...
        "items": [
          {
            "domain": "Reading/Phonics",
            "points": 1,
            "prompt": "Reads, decodes, explains, or responds to the weekly literacy focus: CVC/CVCe comparison and decodable reading."
          },
          {
            "domain": "Writing",
            "points": 1,
  ...
  "assessments": {
    "midterm": {
      "title": "First Grade Midyear Demonstration",
      "unit": 18,
      "passingScore": 80,
      "itemCount": 50,
      "items": [
        {
          ...
          "domain": "Reading/Phonics",
          "points": 1,
          "prompt": "Read or decode grade-appropriate words/sentences, demonstrate sound/spelling knowledge, or answer a text question."
        },
        {
          "number": 2,
          "domain": "Writing",
          "points": 1,
          "prompt": "Write, revise, dictate, or illustrate an opinion, information piece, narrative, label, caption, or complete sentence."
        },
        {
          "number": 3,
          "domain": "Math",
          "points": 1,
          "prompt": "Solve and explain a number, operation, place-value, measurement, data, geometry, time, or equal-share problem."
        },
        {
          "number": 4,
          "domain": "Inquiry",
          "points": 1,
          "prompt": "Observe, compare, map, research, test, classify, design, or explain evidence from science or social studies."
        },
        {
          "number": 5,
          "domain": "SEL",
          "points": 1,
          "prompt": "Demonstrate independence, cooperation, respectful communication, persistence, repair language, or responsible choice-making."
        },
        {
          "number": 6,
          "domain": "Arts/Movement",
          "points": 1,
          "prompt": "Create, perform, build, draw, sing, move, respond, or present using art, music, drama, or physical movement."
        },
        {
          "number": 7,
          "domain": "Reading/Phonics",
    ...
    "final": {
      "title": "First Grade Final Readiness Demonstration",
      "unit": 36,
      "passingScore": 80,
      "itemCount": 60,
      "items": [
