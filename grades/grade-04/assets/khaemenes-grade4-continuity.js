/*
 * Khaemenes Grade 04 · Continuity Bridge v1.0.0
 * ------------------------------------------------
 * Academy Family Registry owns learner identity.
 * Elementary continuity owns mentor routing.
 * Archaemenes is the current Grade 04 mentor.
 * Grade 04 owns course progress and mastery records.
 */
(function attachGrade4Continuity(global){
  ...
  function learner(){
    ...
    if(grade!=="grade-04")return null;
    return Object.freeze({
      learnerId:clean(summary.learner.learnerId,120),
      familyId:clean(summary.learner.familyId,120)||null,
      nickname:clean(summary.learner.nickname||"Fourth Grade Scholar",80),
      stage:"elementary",grade:"grade-04",
  ...
  function normalizeState(value={}){
    ...
    return {
      student:clean(source.student||"Fourth Grade Scholar",80),
      weekly,
  ...
  global.KhaemenesGrade4Continuity=Object.freeze({version:"1.0.0",getLearner:learner,getMentor:()=>learner()?.mentor||null,loadState,saveState,clearActive,getSummary:summary});
})(window);
